...
combined_plot <- function(genome_data, replicon_data, point_size, point_alpha, plot_type,
                          ram_min, ram_max, time_min, time_max, plasmid_contiguity_title = "Plasmid contiguity") {
  ...
  p1 <- ggplot(data = chromosome_data) +
    ...
    theme_bw() + theme(axis.text.x = element_text(color = "black", size = 11)) +
    scale_x_discrete(labels = function(x) str_wrap(x, width = 1)) +
    ...
    labs(title = "Chromosome contiguity", y = "Contiguity", x = NULL)
  ...
  p2 <- ggplot(data = plasmid_data) +
    ...
    coord_cartesian(ylim = y_trans(y_range)) +
    labs(title = plasmid_contiguity_title, y = NULL, x = NULL)
  ...
  p3 <- ggplot(data = chromosome_identity_data) +
    ...
    coord_cartesian(ylim = y_trans(y_range)) +
    labs(title = "Chromosome identity", y = "Percent identity", x = NULL)
  
  p4 <- ggplot(data = time_data) +
    ...
    scale_shape_identity("Platform", labels = c("nanopore", "pacbio"), breaks = c(16, 17)) +
    labs(title = "Runtime", y = "Assembly time", x = NULL)
  ...
  p5 <- ggplot(data = time_data) +
    ...
    theme_bw() + theme(legend.position="none", axis.text.x = element_text(color = "black", size = 11)) +
    scale_y_log10(breaks = c(0.125, 0.25, 0.5, 1, 2, 4, 8, 16, 32, 64), minor_breaks = NULL,
                  labels = c("0.125", "0.25", "0.5", "1", "2", "4", "8", "16", "32", "64")) +
    scale_x_discrete(labels = function(x) str_wrap(x, width = 1)) +
    coord_cartesian(ylim = c(ram_min, ram_max)) + 
    scale_shape_identity("Platform", labels = c("nanopore", "pacbio"), breaks = c(16, 17)) +
    labs(title = "RAM usage", y = "Maximum RAM (GB)", x = NULL)
  ...
  if (plot_type == "legend") {
    ...
    plot_grid(p0, NULL, p1, p3, p4, p5, ncol=2, align="hv", scale = 0.975,
              labels = c("A", "", "B", "C", "D", "E"), label_size = 18, hjust = -1)
...
p1 <- combined_plot(real_genome_data, real_replicon_data,
                    ...
                    ram_min = 1.0, ram_max = 16, time_min = 0.25, time_max = 360,
                    plasmid_contiguity_title = "Real read plasmid contiguity")
...
p2 <- combined_plot(simulated_genome_data, simulated_replicon_data,
                    ...
                    ram_min = 0.1, ram_max = 64, time_min = 0.03, time_max = 1440,
                    plasmid_contiguity_title = "Simulated read plasmid contiguity")
...
```{r problems, fig.width = 4, fig.height = 9}
...
depth_plot <- function(chromosome_data, assembler_name, colour, title, point_size, point_alpha, x_axis) {
  ...
  p <- ggplot(data = chromosome_data) +
    ...
    labs(title = title, y = assembler_name, x= NULL)
  return(p)
}

p1 <- depth_plot(chromosome_data, "Canu v1.9", colour = "#f8766d", title = "A. Read depth", point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p2 <- depth_plot(chromosome_data, "Flye v2.6", colour = "#b79f00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- depth_plot(chromosome_data, "Miniasm+ v0.3", colour = "#00ba38", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- depth_plot(chromosome_data, "Raven v0.0.5", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- depth_plot(chromosome_data, "Redbean v2.5", colour = "#619cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- depth_plot(chromosome_data, "Shasta v0.3.0", colour = "#f564e3", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, ncol=1, align="hv")
...
p2 <- identity_plot(chromosome_data, "Flye v2.6", colour = "#b79f00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- identity_plot(chromosome_data, "Miniasm+ v0.3", colour = "#00ba38", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- identity_plot(chromosome_data, "Raven v0.0.5", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- identity_plot(chromosome_data, "Redbean v2.5", colour = "#619cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- identity_plot(chromosome_data, "Shasta v0.3.0", colour = "#f564e3", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, ncol=1, align="hv")
...
p2 <- n50_plot(chromosome_data, "Flye v2.6", colour = "#b79f00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- n50_plot(chromosome_data, "Miniasm+ v0.3", colour = "#00ba38", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- n50_plot(chromosome_data, "Raven v0.0.5", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- n50_plot(chromosome_data, "Redbean v2.5", colour = "#619cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- n50_plot(chromosome_data, "Shasta v0.3.0", colour = "#f564e3", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, ncol=1, align="hv")
...
random_junk_plot <- function(chromosome_data, assembler_name, colour, title, point_size, point_alpha, x_axis) {
  ...
  p <- ggplot(data = chromosome_data) +
    ...
    scale_y_continuous(breaks = c(0, 0.75, 0.9, 1.0), minor_breaks = NULL,
                       labels = c("0%", "75%", "90%", "100%")) + 
    coord_trans(y = y_trans_problem, limx = c(0, 18), limy = c(-0.6, 1.2)) +
    labs(title = title, y = assembler_name, x= NULL)
  return(p)
}
...
p2 <- random_junk_plot(chromosome_data, "Flye v2.6", colour = "#b79f00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- random_junk_plot(chromosome_data, "Miniasm+ v0.3", colour = "#00ba38", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- random_junk_plot(chromosome_data, "Raven v0.0.5", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- random_junk_plot(chromosome_data, "Redbean v2.5", colour = "#619cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- random_junk_plot(chromosome_data, "Shasta v0.3.0", colour = "#f564e3", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, ncol=1, align="hv")
...
chimera_plot <- function(chromosome_data, assembler_name, colour, title, point_size, point_alpha, x_axis) {
  ...
  p <- ggplot(data = chromosome_data) +
    ...
    scale_y_continuous(breaks = c(0, 0.75, 0.9, 1.0), minor_breaks = NULL,
                       labels = c("0%", "75%", "90%", "100%")) + 
    coord_trans(y = y_trans_problem, limx = c(0, 12), limy = c(-0.6, 1.2)) +
    labs(title = title, y = assembler_name, x= NULL)
  return(p)
}
...
p2 <- chimera_plot(chromosome_data, "Flye v2.6", colour = "#b79f00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- chimera_plot(chromosome_data, "Miniasm+ v0.3", colour = "#00ba38", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- chimera_plot(chromosome_data, "Raven v0.0.5", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- chimera_plot(chromosome_data, "Redbean v2.5", colour = "#619cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- chimera_plot(chromosome_data, "Shasta v0.3.0", colour = "#f564e3", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, ncol=1, align="hv")
...
p2 <- adapter_plot(chromosome_data, "Flye v2.6", colour = "#b79f00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- adapter_plot(chromosome_data, "Miniasm+ v0.3", colour = "#00ba38", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- adapter_plot(chromosome_data, "Raven v0.0.5", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- adapter_plot(chromosome_data, "Redbean v2.5", colour = "#619cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- adapter_plot(chromosome_data, "Shasta v0.3.0", colour = "#f564e3", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, ncol=1, align="hv")
...
p2 <- glitch_plot(chromosome_data, "Flye v2.6", colour = "#b79f00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- glitch_plot(chromosome_data, "Miniasm+ v0.3", colour = "#00ba38", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- glitch_plot(chromosome_data, "Raven v0.0.5", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- glitch_plot(chromosome_data, "Redbean v2.5", colour = "#619cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- glitch_plot(chromosome_data, "Shasta v0.3.0", colour = "#f564e3", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, ncol=1, align="hv")
...
p2 <- gc_plot(chromosome_data, "Flye v2.6", colour = "#b79f00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- gc_plot(chromosome_data, "Miniasm+ v0.3", colour = "#00ba38", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- gc_plot(chromosome_data, "Raven v0.0.5", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- gc_plot(chromosome_data, "Redbean v2.5", colour = "#619cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- gc_plot(chromosome_data, "Shasta v0.3.0", colour = "#f564e3", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, ncol=1, align="hv")
```
...
```{r plasmids, fig.width = 9, fig.height = 6}
...
p2 <- plot_plasmids_one_assembler(sim_plasmid_data, "Flye v2.6", colour = "#b79f00")
p3 <- plot_plasmids_one_assembler(sim_plasmid_data, "Miniasm+ v0.3", colour = "#00ba38")
p4 <- plot_plasmids_one_assembler(sim_plasmid_data, "Raven v0.0.5", colour = "#00bfc4")
p5 <- plot_plasmids_one_assembler(sim_plasmid_data, "Redbean v2.5", colour = "#619cff")
p6 <- plot_plasmids_one_assembler(sim_plasmid_data, "Shasta v0.3.0", colour = "#f564e3")

plot_grid(p1, p2, p3, p4, p5, p6, ncol=3, align="hv")
...
p2 <- plot_plasmids_one_assembler(real_plasmid_data, "Flye v2.6", colour = "#b79f00")
p3 <- plot_plasmids_one_assembler(real_plasmid_data, "Miniasm+ v0.3", colour = "#00ba38")
p4 <- plot_plasmids_one_assembler(real_plasmid_data, "Raven v0.0.5", colour = "#00bfc4")
p5 <- plot_plasmids_one_assembler(real_plasmid_data, "Redbean v2.5", colour = "#619cff")
p6 <- plot_plasmids_one_assembler(real_plasmid_data, "Shasta v0.3.0", colour = "#f564e3")
...
flye_data$ram <- flye_data$`Flye v2.6 RAM (kb)` / 1024 / 1024
flye_data <- flye_data %>% drop_na(ram)
flye_data$time <- flye_data$`Flye v2.6 time`
