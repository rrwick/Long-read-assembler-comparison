...
```{r}
genome_data <- read_excel("Long-read_assembler_comparison.xlsx", sheet = "Per-genome", col_names = TRUE) %>% filter(!is.na(`Canu v2.1 assembly size`))
replicon_data <- read_excel("Long-read_assembler_comparison.xlsx", sheet = "Per-replicon", col_names = TRUE) %>% filter(!is.na(`Canu v2.1 contiguity`))
```
...
plot_grid(p1, p2, p3, p4, p5, p6, p7, p8, p8, p9, p10, p11, p12, ncol=3, align="hv")
```
...
combined_plot <- function(genome_data, replicon_data, point_size, point_alpha, plot_type,
  ...
  p2 <- ggplot(data = plasmid_data) +
    ...
    coord_cartesian(ylim = y_trans(y_range)) +
    labs(title = "C. Plasmid contiguity", y = "Contiguity", x = NULL)
  ...
  p3 <- ggplot(data = chromosome_identity_data) +
    ...
    coord_cartesian(ylim = y_trans(y_range)) +
    labs(title = "D. Chromosome identity", y = "Percent identity", x = NULL)
  ...
  p4 <- ggplot(data = chromosome_max_indel_data) +
    ...
    labs(title = "E. Chromosome max indel", y = "Max indel", x = NULL)
  ...
  p5 <- ggplot(data = time_data) +
    ...
    scale_shape_identity("Platform", labels = c("nanopore", "pacbio"), breaks = c(16, 17)) +
    labs(title = "F. Runtime", y = "Assembly time", x = NULL)
  ...
  p6 <- ggplot(data = time_data) +
    ...
    scale_shape_identity("Platform", labels = c("nanopore", "pacbio"), breaks = c(16, 17)) +
    labs(title = "G. RAM usage", y = "Maximum RAM (GB)", x = NULL)
  ...
  if (plot_type == "legend") {
    ...
    plot_grid(p0, NULL, p1, p2, p3, p4, p5, p6, ncol=2, align="hv", scale = 0.975)
  }
}
```
...
```{r problems, fig.width = 4, fig.height = 11}
...
p1 <- depth_plot(chromosome_data, "Canu v2.1", colour = "#f8766d", title = "A. Read depth", point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p2 <- depth_plot(chromosome_data, "Flye v2.8", colour = "#cd9600", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- depth_plot(chromosome_data, "Miniasm+ v0.3", colour = "#7cae00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- depth_plot(chromosome_data, "NECAT v20200803", colour = "#00be67", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- depth_plot(chromosome_data, "NextDenovo v2.3.1", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- depth_plot(chromosome_data, "Raven v1.3.0", colour = "#00a9ff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p7 <- depth_plot(chromosome_data, "Redbean v2.5", colour = "#c77cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p8 <- depth_plot(chromosome_data, "Shasta v0.7.0", colour = "#ff61cc", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, p7, p8, ncol=1, align="hv")
...
p1 <- identity_plot(chromosome_data, "Canu v2.1", colour = "#f8766d", title = "B. Max read identity", point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p2 <- identity_plot(chromosome_data, "Flye v2.8", colour = "#cd9600", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- identity_plot(chromosome_data, "Miniasm+ v0.3", colour = "#7cae00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- identity_plot(chromosome_data, "NECAT v20200803", colour = "#00be67", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- identity_plot(chromosome_data, "NextDenovo v2.3.1", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- identity_plot(chromosome_data, "Raven v1.3.0", colour = "#00a9ff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p7 <- identity_plot(chromosome_data, "Redbean v2.5", colour = "#c77cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p8 <- identity_plot(chromosome_data, "Shasta v0.7.0", colour = "#ff61cc", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, p7, p8, ncol=1, align="hv")
...
p1 <- n50_plot(chromosome_data, "Canu v2.1", colour = "#f8766d", title = "C. Read N50 length", point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p2 <- n50_plot(chromosome_data, "Flye v2.8", colour = "#cd9600", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- n50_plot(chromosome_data, "Miniasm+ v0.3", colour = "#7cae00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- n50_plot(chromosome_data, "NECAT v20200803", colour = "#00be67", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- n50_plot(chromosome_data, "NextDenovo v2.3.1", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- n50_plot(chromosome_data, "Raven v1.3.0", colour = "#00a9ff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p7 <- n50_plot(chromosome_data, "Redbean v2.5", colour = "#c77cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p8 <- n50_plot(chromosome_data, "Shasta v0.7.0", colour = "#ff61cc", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, p7, p8, ncol=1, align="hv")
...
p1 <- random_junk_plot(chromosome_data, "Canu v2.1", colour = "#f8766d", title = "D. Random+junk rates", point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p2 <- random_junk_plot(chromosome_data, "Flye v2.8", colour = "#cd9600", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- random_junk_plot(chromosome_data, "Miniasm+ v0.3", colour = "#7cae00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- random_junk_plot(chromosome_data, "NECAT v20200803", colour = "#00be67", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- random_junk_plot(chromosome_data, "NextDenovo v2.3.1", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- random_junk_plot(chromosome_data, "Raven v1.3.0", colour = "#00a9ff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p7 <- random_junk_plot(chromosome_data, "Redbean v2.5", colour = "#c77cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p8 <- random_junk_plot(chromosome_data, "Shasta v0.7.0", colour = "#ff61cc", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, p7, p8, ncol=1, align="hv")
...
p1 <- chimera_plot(chromosome_data, "Canu v2.1", colour = "#f8766d", title = "E. Chimera rates", point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p2 <- chimera_plot(chromosome_data, "Flye v2.8", colour = "#cd9600", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- chimera_plot(chromosome_data, "Miniasm+ v0.3", colour = "#7cae00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- chimera_plot(chromosome_data, "NECAT v20200803", colour = "#00be67", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- chimera_plot(chromosome_data, "NextDenovo v2.3.1", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- chimera_plot(chromosome_data, "Raven v1.3.0", colour = "#00a9ff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p7 <- chimera_plot(chromosome_data, "Redbean v2.5", colour = "#c77cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p8 <- chimera_plot(chromosome_data, "Shasta v0.7.0", colour = "#ff61cc", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, p7, p8, ncol=1, align="hv")
...
p1 <- adapter_plot(chromosome_data, "Canu v2.1", colour = "#f8766d", title = "F. Adapter length", point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p2 <- adapter_plot(chromosome_data, "Flye v2.8", colour = "#cd9600", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- adapter_plot(chromosome_data, "Miniasm+ v0.3", colour = "#7cae00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- adapter_plot(chromosome_data, "NECAT v20200803", colour = "#00be67", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- adapter_plot(chromosome_data, "NextDenovo v2.3.1", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- adapter_plot(chromosome_data, "Raven v1.3.0", colour = "#00a9ff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p7 <- adapter_plot(chromosome_data, "Redbean v2.5", colour = "#c77cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p8 <- adapter_plot(chromosome_data, "Shasta v0.7.0", colour = "#ff61cc", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, p7, p8, ncol=1, align="hv")
...
p1 <- glitch_plot(chromosome_data, "Canu v2.1", colour = "#f8766d", title = "G. Glitch size/skip", point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p2 <- glitch_plot(chromosome_data, "Flye v2.8", colour = "#cd9600", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- glitch_plot(chromosome_data, "Miniasm+ v0.3", colour = "#7cae00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- glitch_plot(chromosome_data, "NECAT v20200803", colour = "#00be67", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- glitch_plot(chromosome_data, "NextDenovo v2.3.1", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- glitch_plot(chromosome_data, "Raven v1.3.0", colour = "#00a9ff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p7 <- glitch_plot(chromosome_data, "Redbean v2.5", colour = "#c77cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p8 <- glitch_plot(chromosome_data, "Shasta v0.7.0", colour = "#ff61cc", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, p7, p8, ncol=1, align="hv")
...
p1 <- gc_plot(chromosome_data, "Canu v2.1", colour = "#f8766d", title = "GC content", point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p2 <- gc_plot(chromosome_data, "Flye v2.8", colour = "#cd9600", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p3 <- gc_plot(chromosome_data, "Miniasm+ v0.3", colour = "#7cae00", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p4 <- gc_plot(chromosome_data, "NECAT v20200803", colour = "#00be67", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p5 <- gc_plot(chromosome_data, "NextDenovo v2.3.1", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p6 <- gc_plot(chromosome_data, "Raven v1.3.0", colour = "#00a9ff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p7 <- gc_plot(chromosome_data, "Redbean v2.5", colour = "#c77cff", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
p8 <- gc_plot(chromosome_data, "Shasta v0.7.0", colour = "#ff61cc", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = TRUE)
plot_grid(p1, p2, p3, p4, p5, p6, p7, p8, ncol=1, align="hv")
```
...
p1 <- plot_plasmids_one_assembler(sim_plasmid_data, "Canu v2.1", colour = "#f8766d")
p2 <- plot_plasmids_one_assembler(sim_plasmid_data, "Flye v2.8", colour = "#cd9600")
p3 <- plot_plasmids_one_assembler(sim_plasmid_data, "Miniasm+ v0.3", colour = "#7cae00")
p4 <- plot_plasmids_one_assembler(sim_plasmid_data, "NECAT v20200803", colour = "#00be67")
p5 <- plot_plasmids_one_assembler(sim_plasmid_data, "NextDenovo v2.3.1", colour = "#00bfc4")
p6 <- plot_plasmids_one_assembler(sim_plasmid_data, "Raven v1.3.0", colour = "#00a9ff")
p7 <- plot_plasmids_one_assembler(sim_plasmid_data, "Redbean v2.5", colour = "#c77cff")
p8 <- plot_plasmids_one_assembler(sim_plasmid_data, "Shasta v0.7.0", colour = "#ff61cc")
...
p1 <- plot_plasmids_one_assembler(real_plasmid_data, "Canu v2.1", colour = "#f8766d")
p2 <- plot_plasmids_one_assembler(real_plasmid_data, "Flye v2.8", colour = "#cd9600")
p3 <- plot_plasmids_one_assembler(real_plasmid_data, "Miniasm+ v0.3", colour = "#7cae00")
p4 <- plot_plasmids_one_assembler(real_plasmid_data, "NECAT v20200803", colour = "#00be67")
p5 <- plot_plasmids_one_assembler(real_plasmid_data, "NextDenovo v2.3.1", colour = "#00bfc4")
p6 <- plot_plasmids_one_assembler(real_plasmid_data, "Raven v1.3.0", colour = "#00a9ff")
p7 <- plot_plasmids_one_assembler(real_plasmid_data, "Redbean v2.5", colour = "#c77cff")
p8 <- plot_plasmids_one_assembler(real_plasmid_data, "Shasta v0.7.0", colour = "#ff61cc")
...
flye_data$ram <- flye_data$`Flye v2.8 RAM (kb)` / 1024 / 1024
flye_data <- flye_data %>% drop_na(ram)
flye_data$time <- flye_data$`Flye v2.8 time`
...
canu_data$time <- canu_data$`Canu v2.1 time`
