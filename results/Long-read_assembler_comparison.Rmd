...
p1 <- combined_plot(real_genome_data, real_replicon_data,
                    ...
                    ram_min = 1.0, ram_max = 16, time_min = 0.25, time_max = 360,
                    plasmid_contiguity_title = "A. Real read plasmid contiguity")
...
p2 <- combined_plot(simulated_genome_data, simulated_replicon_data,
                    ...
                    ram_min = 0.1, ram_max = 64, time_min = 0.03, time_max = 1440,
                    plasmid_contiguity_title = "B. Simulated read plasmid contiguity")
...
p4 <- depth_plot(chromosome_data, "Raven v0.0.7", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
...
p4 <- identity_plot(chromosome_data, "Raven v0.0.7", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
...
p4 <- n50_plot(chromosome_data, "Raven v0.0.7", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
...
p4 <- random_junk_plot(chromosome_data, "Raven v0.0.7", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
...
p4 <- chimera_plot(chromosome_data, "Raven v0.0.7", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
...
p4 <- adapter_plot(chromosome_data, "Raven v0.0.7", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
...
p4 <- glitch_plot(chromosome_data, "Raven v0.0.7", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
...
p4 <- gc_plot(chromosome_data, "Raven v0.0.7", colour = "#00bfc4", title = NULL, point_size = 1.0, point_alpha = 0.6, x_axis = FALSE)
...
p4 <- plot_plasmids_one_assembler(sim_plasmid_data, "Raven v0.0.7", colour = "#00bfc4")
...
p4 <- plot_plasmids_one_assembler(real_plasmid_data, "Raven v0.0.7", colour = "#00bfc4")
